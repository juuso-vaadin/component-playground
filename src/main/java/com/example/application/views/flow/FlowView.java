...
@PageTitle("Flow")
@Menu(icon = "line-awesome/svg/java.svg", order = 0)
@Route(value = "")
public class FlowView extends VerticalLayout {
    ...
    public FlowView() {
        ...
        viewHeader.add(title, new ThemeSelect("Theme"), state);
viewHeader.addClassNames(LumoUtility.Gap.MEDIUM);
    ...
    private Component createFieldExamples() {
        ...
        comboBox.addClassName("flow-view-combo-box-1");
        //<theme-editor-local-classname>
        comboBox.setOverlayClassName("flow-view-combo-box-1");
